...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" OPERATION="FLOAT2FIXED" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=7 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 clk_en clock dataa result
...
//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" PIPELINE=2 SHIFTDIR="VARIABLE" SHIFTTYPE="LOGICAL" WIDTH=54 WIDTHDIST=6 aclr clk_en clock data direction distance result
...
module  convert_25_altbarrel_shift_g4h
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //convert_25_altbarrel_shift_g4h

//synthesis_resources = lpm_add_sub 6 lpm_compare 4 reg 282 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  convert_25_altfp_convert_ajn
	( 
	clk_en,
	clock,
	dataa,
...
`endif
	...
	wire  [53:0]   wire_altbarrel_shift2_result;
	...
	wire  [30:0]   wire_add_1_adder_result;
	wire  [5:0]   wire_add_sub1_result;
	wire  wire_add_sub3_cout;
	wire  [14:0]   wire_add_sub3_result;
	wire  [15:0]   wire_add_sub4_result;
	...
	convert_25_altbarrel_shift_g4h   altbarrel_shift2
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	assign
		...
		const_bias_value_add_width_res_w = 8'b10000101,
		...
		inv_add_1_adder2_w = (({16{(~ wire_add_sub3_cout)}} & inv_integer[30:15]) | ({16{wire_add_sub3_cout}} & wire_add_sub4_result)),
...
endmodule //convert_25_altfp_convert_ajn
//VALID FILE
...
//	end
assign done = 1'b1;
	convert_25_altfp_convert_ajn	convert_25_altfp_convert_ajn_component (
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
