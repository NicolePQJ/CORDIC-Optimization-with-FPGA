...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" OPERATION="FIXED2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=7 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 clk_en clock dataa result
...
module  convert_back_25_altbarrel_shift_fof
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //convert_back_25_altbarrel_shift_fof
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  convert_back_25_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //convert_back_25_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  convert_back_25_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	convert_back_25_altpriority_encoder_3e8   altpriority_encoder13
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder13_q),
	.zero(wire_altpriority_encoder13_zero));
	convert_back_25_altpriority_encoder_3e8   altpriority_encoder14
	( 
	.data(data[3:2]),
...
endmodule //convert_back_25_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  convert_back_25_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	convert_back_25_altpriority_encoder_6e8   altpriority_encoder11
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder11_q),
	.zero(wire_altpriority_encoder11_zero));
	convert_back_25_altpriority_encoder_6e8   altpriority_encoder12
	( 
	.data(data[7:4]),
...
endmodule //convert_back_25_altpriority_encoder_be8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  convert_back_25_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //convert_back_25_altpriority_encoder_3v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  convert_back_25_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	convert_back_25_altpriority_encoder_3v7   altpriority_encoder17
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder17_q));
	convert_back_25_altpriority_encoder_3e8   altpriority_encoder18
	( 
	.data(data[3:2]),
...
endmodule //convert_back_25_altpriority_encoder_6v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  convert_back_25_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	convert_back_25_altpriority_encoder_6v7   altpriority_encoder15
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder15_q));
	convert_back_25_altpriority_encoder_6e8   altpriority_encoder16
	( 
	.data(data[7:4]),
...
endmodule //convert_back_25_altpriority_encoder_bv7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  convert_back_25_altpriority_encoder_r08
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	convert_back_25_altpriority_encoder_be8   altpriority_encoder10
	( 
	.data(data[15:8]),
	.q(wire_altpriority_encoder10_q),
	.zero(wire_altpriority_encoder10_zero));
	convert_back_25_altpriority_encoder_bv7   altpriority_encoder9
	( 
	.data(data[7:0]),
...
endmodule //convert_back_25_altpriority_encoder_r08
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  convert_back_25_altpriority_encoder_rf8
	( 
	data,
	q,
	zero) ;
	...
	convert_back_25_altpriority_encoder_be8   altpriority_encoder19
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder19_q),
	.zero(wire_altpriority_encoder19_zero));
	convert_back_25_altpriority_encoder_be8   altpriority_encoder20
	( 
	.data(data[15:8]),
...
endmodule //convert_back_25_altpriority_encoder_rf8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  convert_back_25_altpriority_encoder_qb6
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	convert_back_25_altpriority_encoder_r08   altpriority_encoder7
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder7_q));
	convert_back_25_altpriority_encoder_rf8   altpriority_encoder8
	( 
	.data(data[31:16]),
...
endmodule //convert_back_25_altpriority_encoder_qb6

//synthesis_resources = lpm_add_sub 5 lpm_compare 1 reg 247 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  convert_back_25_altfp_convert_ajn
	( 
	clk_en,
	clock,
	dataa,
...
`endif
	...
	wire  [31:0]   wire_altbarrel_shift3_result;
	...
	convert_back_25_altbarrel_shift_fof   altbarrel_shift3
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	convert_back_25_altpriority_encoder_qb6   altpriority_encoder2
	( 
	.data(prio_mag_int_a),
	...
	assign
		...
		bias_value_w = 8'b01100110,
		const_bias_value_add_width_int_w = 8'b10000100,
		...
		exponent_rounded = (({8{(~ mantissa_overflow)}} & exponent_bus_pre_reg) | ({8{mantissa_overflow}} & wire_add_sub6_result)),
...
endmodule //convert_back_25_altfp_convert_ajn
//VALID FILE
...
//	
//	always@(*) begin
//	   if (counter == 4'b0000 && busy == 1) begin
//		   done = 1'b1;
//			//result = sub_wire0;
//		end
//		else begin
...
//	end
   assign done = 1'b1;
	...
	convert_back_25_altfp_convert_ajn	convert_back_25_altfp_convert_ajn_component (
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
